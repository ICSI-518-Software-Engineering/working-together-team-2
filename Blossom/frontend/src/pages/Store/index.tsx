...
const StorePage: React.FC<StorePageProps> = () => {
  ...
  return (
    <Box>
      ...
      >
        <Box color="Black" fontSize={24} fontWeight="bold" mb={2}>
      ...
      >
        <div
          style={{
            ...
            boxShadow:
              "0px 0px 20px rgba(0, 0, 0, 0.2)" /* Box shadow for depth */,
          }}
        >
          <h2
            style={{
          ...
          <p style={{ fontSize: "18px", lineHeight: "1.5" }}>
            From birthdays to weddings, we've got you covered. Let's make your
            event unforgettable. Get in touch today!
          </p>
      ...
      >
        ...
        >
          ...
          >
            Personalize your products to make them uniquely yours. Whether it's
            engraving a message on jewelry or adding a custom design to
            clothing, we'll help you create something special. Let us turn your
            ideas into reality.
          </p>
        ...
        <img
          src={customizeImage}
          alt="Left Image"
          style={{ width: "40%", height: "650px", borderRadius: "0px" }}
        />
      </div>
      ...
      >
        ...
        >
          ...
          >
            Suggesting a Bouquet for Your Loved Ones?
          </h2>
          <p
            style={{
              fontFamily: "Arial, sans-serif",
          ...
          >
            Let us help you find the perfect bouquet for any occasion. Our
            expert florists will craft stunning arrangements to express your
            love and affection. Make your moments more memorable with our
